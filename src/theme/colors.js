// ─── COLORS ───────────────────────────────────────────────────────────────────
// App-wide color palette. Single source of truth for every hue used in the UI.
// Any redesign is a one-file change.
...
export const COLORS = {
  ...
  // Gradients (used as `colors` array in LinearGradient)
