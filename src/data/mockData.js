...
// ── Academic summary ─────────────────────────────────────────────────────────
// Single source of truth for the CGPA shown across Profile / Grades / All Semesters.
...
// ── Class status ─────────────────────────────────────────────────────────────
// Drives the pill, timeline dot and card treatment on the Schedule screen.
...
export const CLASSES = [
  ...
  },
  {
    ...
    accent: 'blue',
    status: 'cancelled',
    statusNote: 'Cancelled by Ms. Ayesha Khan — faculty meeting',
    hasPrep: false,
  },
  {
    id: '4',
    ...
    accent: 'orange',
    status: 'rescheduled',
    statusNote: 'Moved to Fri, 18 Apr · 02:00 PM — Room 12',
    hasPrep: false,
  },
];
...
// ── Semester history ─────────────────────────────────────────────────────────
// Canonical academic record. `courses[].letterVariant` / `progressVariant` are
// keys of ACCENT in src/theme/colors.js, so the UI can look them up directly.
// The row subtitle is derived in the UI as `${term} • ${courses.length} Courses`.
export const SEMESTER_HISTORY = [
  {
    ...
    gpa: '3.92',
    isCurrent: true,
    finalNumbersUpdated: false, // GPA provisional — final marks not yet released
    courses: [
      {
        id: 'sem8-1',
        name: 'Web Development',
